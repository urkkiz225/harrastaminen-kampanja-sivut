...
const events: Record<number, Event[]> = {
  ...
  3: [//to
    ...
    { time: "18.00 - 20.00", title: "Pilates", desc: "Tule rentoutumaan Pilatekseen kello 18-20 koulutetun ohjaajan johdolla.", location: "Pilates Circle Helsinki",  color: "bg-secondary/70", address: "Työpajankatu 10 A 4. krs, 00580 Helsinki", addressURL: "https://www.google.com/maps/place/Pilates+Circle-studio/@60.1882814,24.9746896,17z/data=!3m1!4b1!4m6!3m5!1s0x469209707bd5d421:0xd50c09fbd802b8f!8m2!3d60.1882814!4d24.9772645!16s%2Fg%2F11dzd8d5nq?entry=ttu&g_ep=EgoyMDI2MDUwNi4wIKXMDSoASAFQAw%3D%3D", extendedDesc: "Vahvista kehoasi ja huolla mieltäsi Pilates-tunnilla. Keskitymme syvien lihasten hallintaan, hyvään ryhtiin ja hallittuun hengitykseen koulutetun ohjaajan johdolla. Tunti sopii kaikentasoisille liikkujille, ja liikkeet tehdään omaa kehoa kuunnellen. Ota mukaan mukavat vaatteet ja tule nauttimaan rauhallisesta, mutta tehokkaasta treenistä!" }
  ],
  4: [//pe
    { time: "10.00 - 11.00", title: "Rullaluistelu", desc: "Nappaa rullat alle ja anna vauhdin viedä – löydä uusi tapa liikkua ja pitää hauskaa!", location: "Vallilan sisärullaluisteluhalli", color: "bg-secondary/70", address: "PLACEHOLDER ADDRESS", addressURL: "PLACEHOLDER URL", extendedDesc: "EXTENDED DESC PLACEHOLDER" },
  ...
  6: [//su
    ...
    { time: "16.00 - 21.00", title: "Marjastus", desc: "ervetuloa marjastamaan iltapäivän kajoon luonnon helmaan!", location: "Riistavuoren metsäalue", color: "bg-accent", address: "PLACEHOLDER ADDRESS", addressURL: "PLACEHOLDER URL", extendedDesc: "EXTENDED DESC PLACEHOLDER" }
  ]
};
