...
export default function Quotes() {
    ...
    return (
        ...
        <section id="henkilotarinat" className="relative w-full max-w-7xl mx-auto pt-28 mt-80 sm:mt-64 md:mt-38 lg:mt-[60] mb-10 sm:mb-24 md:mb-72 pb-0 lg:pt-24 lg:pb-[10rem] px-6 bg-[#F7F3EE]">
{/* Muodot ja kuva */}
